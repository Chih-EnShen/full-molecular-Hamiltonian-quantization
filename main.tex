...
\begin{equation}
T = \frac{1}{2}\sum_j M_j \dot{\mathbf R}_j^2 + \frac{1}{2}\sum_i m_e \dot{\mathbf r}_i^2 ,
\end{equation}
...
= \mathbf R_{\mathrm{ncm}} + \frac{m_e}{M_{\mathrm{tot}}}\sum_i \mathbf r'_i ,
\end{equation}
...
\begin{equation}
\mathbf R_{\mathrm{ncm}} = \mathbf R_{\mathrm{cm}} - \frac{m_e}{M_{\mathrm{tot}}}\sum_l \mathbf r'_l ,
\end{equation}
and therefore
\begin{equation}
\mathbf R_j = \mathbf R_{\mathrm{cm}} + \mathbf R'_j - \frac{m_e}{M_{\mathrm{tot}}}\sum_l \mathbf r'_l ,
\qquad
\mathbf r_i = \mathbf R_{\mathrm{cm}} + \mathbf r'_i - \frac{m_e}{M_{\mathrm{tot}}}\sum_l \mathbf r'_l .
\end{equation}
...
\qquad
\dot{\mathbf r}_i = \mathbf D + \dot{\mathbf r}'_i .
\end{equation}
...
= \frac12 M_N \mathbf D^2 + \mathbf D\cdot\underbrace{\sum_j M_j\dot{\mathbf R}'_j}_{=\,0} + \frac12\sum_j M_j\dot{\mathbf R}_j^{'2} .
\end{equation}
...
= \frac12 N_{\mathrm{elec}}\,m_e \mathbf D^2 + m_e\,\mathbf D\cdot\sum_i\dot{\mathbf r}'_i + \frac12 m_e\sum_i\dot{\mathbf r}_i^{'2} .
\end{equation}
Adding, with $M_N + N_{\mathrm{elec}}m_e = M_{\mathrm{tot}}$,
\begin{equation}
T = \frac12 M_{\mathrm{tot}}\mathbf D^2 + m_e\,\mathbf D\cdot\sum_i\dot{\mathbf r}'_i + \frac12\sum_j M_j\dot{\mathbf R}_j^{'2} + \frac12 m_e\sum_i\dot{\mathbf r}_i^{'2} .
\end{equation}
...
- \frac{m_e^2}{M_{\mathrm{tot}}}\Bigl(\sum_l\dot{\mathbf r}'_l\Bigr)^2 .
\end{align}
...
\begin{equation}
\boxed{\;\mathbf P_{\mathrm{cm}} = \frac{\partial L}{\partial\dot{\mathbf R}_{\mathrm{cm}}} = M_{\mathrm{tot}}\dot{\mathbf R}_{\mathrm{cm}} .\;}
\end{equation}
...
= \frac{m_e M_N}{M_{\mathrm{tot}}}\sum_l\dot{\mathbf r}'_l ,
\end{equation}
...
\begin{equation}
\boxed{\;\mathbf P'_j = M_j\dot{\mathbf R}'_j .\;}
\end{equation}
...
= \frac{\mathbf P_{\mathrm{cm}}}{M_{\mathrm{tot}}} - \frac{1}{M_N}\sum_l\mathbf p'_l ,
\end{equation}
...
= \sum_i\frac{\mathbf p_i^{'2}}{2m_e} + \frac{\bar{\mathbf P}^2}{M_N} + \frac{N_{\mathrm{elec}}m_e}{2M_N^2}\bar{\mathbf P}^2 ,
\end{equation}
...
= -\frac{M_{\mathrm{tot}}}{2M_N^2}\,\bar{\mathbf P}^2 .
\end{equation}
...
\qquad \mathbf J_{il} = 1 \ \text{(all-ones block)},
\end{equation}
...
= \sum_i\frac{\mathbf p_i^{'2}}{2m_e} + \frac{1}{2M_N}\Bigl(\sum_i\mathbf p'_i\Bigr)^2 ,
\end{equation}
