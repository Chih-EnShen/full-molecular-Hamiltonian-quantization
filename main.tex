...
\end{equation}
of (4.11). This reproduces Watson's reduction~\cite{watson1968}. The cancellation is special to rectilinear normal coordinates: for general curvilinear $Q_b$ the residue (B.6) does \emph{not} collapse to the trace, leaving the additional vibrational extrapotential terms anticipated in Section 4.1. The electronic sector contributes nothing to $\hat U$, since $\boldsymbol\mu$, $\gamma$, and $\boldsymbol\sigma$ depend on $Q$ alone.
